...
local aa = {
    ...
    [60] = function()
        ...
        function c.New(d, e, f)
            ...
            if _hasVideo and _vid then
                ...
                u("TextLabel",{Size=UDim2.fromOffset(24,22),BackgroundTransparency=1,Text=tostring(math.floor(_vol*100)).."%",TextSize=10,Font=Enum.Font.Gotham,ZIndex=5,Parent=_controls,ThemeTag={TextColor3="SubText"}})
            ...
            _wrap.MouseEnter:Connect(function() if _hasVideo then _controls.Visible=true  end end)
            _wrap.MouseLeave:Connect(function() if _hasVideo then _controls.Visible=false end end)
    ...
    [65] = function()
        ...
        function c.New(d, e, f)
            ...
            u("UICorner",{CornerRadius=UDim.new(0,8),Parent=_wrap})
            u("UIStroke",{Transparency=0.6,Thickness=1,ThemeTag={Color="InElementBorder"},Parent=_wrap})
            u("UIPadding",{PaddingLeft=UDim.new(0,10),PaddingRight=UDim.new(0,10),PaddingTop=UDim.new(0,6),PaddingBottom=UDim.new(0,6),Parent=_wrap})
            ...
            local _statusLbl = u("TextLabel",{
                ...
                BackgroundTransparency=1,
                Text=_hasAudio and "Audio" or "No audio source",
                TextSize=11,
            ...
            function _mod:SetAudio(src)
                ...
                _statusLbl.Text   = _hasAudio and "Audio" or "No audio source"
            end
